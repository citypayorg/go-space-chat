(function (t) {
    function e(e) { for (var r, a, s = e[0], u = e[1], l = e[2], d = 0, g = []; d < s.length; d++)a = s[d], Object.prototype.hasOwnProperty.call(n, a) && n[a] && g.push(n[a][0]), n[a] = 0; for (r in u) Object.prototype.hasOwnProperty.call(u, r) && (t[r] = u[r]); p && p(e); while (g.length) g.shift()(); return i.push.apply(i, l || []), o() }
    function o() {
    ...
    } var r = {}, n = { app: 0 }, i = []; function a(e) { if (r[e]) return r[e].exports; var o = r[e] = { i: e, l: !1, exports: {} }; return t[e].call(o.exports, o, o.exports, a), o.l = !0, o.exports } a.m = t, a.c = r, a.d = function (t, e, o) { a.o(t, e) || Object.defineProperty(t, e, { enumerable: !0, get: o }) }, a.r = function (t) { "undefined" !== typeof Symbol && Symbol.toStringTag && Object.defineProperty(t, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(t, "__esModule", { value: !0 }) }, a.t = function (t, e) { if (1 & e && (t = a(t)), 8 & e) return t; if (4 & e && "object" === typeof t && t && t.__esModule) return t; var o = Object.create(null); if (a.r(o), Object.defineProperty(o, "default", { enumerable: !0, value: t }), 2 & e && "string" != typeof t) for (var r in t) a.d(o, r, function (e) { return t[e] }.bind(null, r)); return o }, a.n = function (t) {
    ...
    0: function (t, e, o) { t.exports = o("56d7") }, "034f": function (t, e, o) {
        ...
        }, s = [], u = (o("cb29"), o("b0c0"), o("d3b7"), o("25f0"), o("8513"), o("9d58"), null), l = null, p = [], d = 200, g = { x: 0, y: 0, z: 10 }, c = 3, f = { up: 87, down: 83, left: 65, right: 68, talk: 32, send: 13 }, h = { x: 0, y: 0 },
        ...
        function A() {
            ...
            u.shadowColor = "white", u.shadowBlur = 10, h = { x: l.width / 2, y: l.height / 2 }, g.x = l.width / 2, g.y = l.height / 2, b.x.max = l.width, b.y.max = l.height, p = L(), k.bot_id = Math.random().toString(36).substr(2), D()
        }
        function C() { u.clearRect(0, 0, l.width, l.height), u.fillStyle = "rgb(20,7,34)", u.fillRect(0, 0, l.width, l.height), I(), p = N(p, m), Y(u, p), at(), k.x = g.x, k.y = g.y, pt(), tt(), window.requestAnimationFrame(C) }
        ...
        function N(t) {
            ...
            for (var o in t) { var r = t[o]; r.x += e[0], r.y += e[1], r.z += e[2], r.x > l.width ? r.x -= l.width : r.x < 0 && (r.x += l.width), r.y > l.height ? r.y -= l.height : r.y < 0 && (r.y += l.height), t[o] = r } return t
        }
        function T(t) {
        ...
        function Y(t) { var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : []; for (var o in e) { var r = G(e[o].x, e[o].y, e[o].z, e[o].c, e[o].s); (r.x < l.width || r.y < l.height) && $(t, r.x, r.y, r.c, r.s) } }
        ...
        function H() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : l.width / 2, e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : l.height / 2; u.beginPath(), t += 5, e += 5, u.arc(t, e, 8, 0, 2 * Math.PI), k.gender === proto.botStatusRequest.gender_type.WOMAN ? u.fillStyle = "rgb(255,20,147)" : u.fillStyle = "rgb(0,191,255)", u.fill(), u.beginPath();
            var o = U(t, e, 8); k.e_x = o[0], k.e_y = o[1], u.arc(o[0], o[1], 4, 0, 2 * Math.PI), u.fillStyle = "rgb(255,255,255)", u.fill(), u.font = "12px Arial", k.gender === proto.botStatusRequest.gender_type.WOMAN ? u.fillStyle = "rgb(255,20,147)" : u.fillStyle = "rgb(0,191,255)", u.fillText(k.name, t - 8, e + 20)
        }
        function J() {
        ...
        function U(t, e, o) {
            var r = 5, n = (t - M.x) * (o - r) / Math.sqrt(Math.pow(t - M.x, 2) + Math.pow(e - M.y, 2)), i = (e - M.y) * (o - r) / Math.sqrt(Math.pow(t - M.x, 2) + Math.pow(e - M.y, 2)); x.up ? (n = 0, i = o - r) : x.down && (n = 0, i = -(o - r)), x.left ? (n = o - r, i = 0) : x.right && (n = -(o - r), i = 0);
            var a = Math.sqrt(Math.pow(o - r, 2) / 2); return x.up && x.left ? (n = a, i = a) : x.up && x.right ? (n = -a, i = a) : x.down && x.left ? (n = a, i = -a) : x.down && x.right && (n = -a, i = -a), [t - n, e - i]
        }
        function V() {
            window.addEventListener("keydown", (function (t) {
                if (_ && t.keyCode != f.send) return !1; switch (t.keyCode) {
                    case f.up: x.up = !0, x.down = !1; break; case f.down: x.up = !1, x.down = !0; break;
                    case f.right: x.right = !0, x.left = !1; break; case f.left: x.left = !0, x.right = !1;
                        break; case f.talk: K(); break;
                    case f.send: Q(); break
                }
            })), window.addEventListener("keyup", (function (t) { switch (t.keyCode) { case f.up: x.up = !1; break; case f.down: x.down = !1; break; case f.right: x.right = !1; break; case f.left: x.left = !1; break }t.keyCode != f.up && t.keyCode != f.down && t.keyCode != f.left && t.keyCode != f.right || (S = !0, v = 1) })), window.addEventListener("mousemove", (function (t) { M = { x: t.x, y: t.y } })), document.body.addEventListener("touchmove", (function (t) { t.preventDefault() }))
        }
        function K() {
            if (null != F) return !1; _ = !0, F = document.createElement("input"), F.setAttribute("style", "position:fixed;left:" + g.x + "px;top:" + (g.y + 30) + "px;background-color:rgba(200,200,200,0.2);border:1px solid rgba(200,200,200,0.2);border-radius:10px;padding:5px;outline:none;width:150px;color:white;font-size:12px"), F.setAttribute("maxlength", 50),
                document.body.appendChild(F), F.addEventListener("focus", (function () { })), F.addEventListener("blur", (function () { document.body.removeChild(F), F = null, _ = !1 })), F.focus()
        }
        function Q() { if (!F || !F.value) return !1; var t = F.value; F.blur(), null == q && (q = document.createElement("div"), q.setAttribute("style", "position:fixed;left:" + g.x + "px;bottom:" + (l.height - g.y + 20) + "px;color:white;font-size:12px"), document.body.appendChild(q)), Z(t), pt(t) }
        function Z(t) { var e = document.createElement("p"); e.innerHTML = "<span style='padding:0 5px;margin:5px 0;display:inline-block;background-color:rgba(200,200,200,0.2);border:1px solid rgba(200,200,200,0.2);border-radius:10px;'>" + t + "</span>", q.appendChild(e), setTimeout((function () { q.removeChild(e) }), 8e3) }
        ...
        function ot(t) { O[t] || (O[t] = document.createElement("div"), O[t].setAttribute("style", "position:fixed;left:" + (W[t].x + W[t].r_x - P.x) + "px;bottom:" + (l.height - (W[t].y + W[t].r_y - P.y) + 20) + "px;color:white;font-size:12px"), document.body.appendChild(O[t])) }
        function rt(t, e) { W[t]; var o = O[t], r = document.createElement("p"); r.innerHTML = "<span style='padding:0 5px;margin:5px 0;display:inline-block;background-color:rgba(200,200,200,0.2);border:1px solid rgba(200,200,200,0.2);border-radius:10px;'>" + e + "</span>", o.appendChild(r), setTimeout((function () { o.removeChild(r) }), 15e3) }
        function nt(t) { var e = W[t], o = O[t]; o.setAttribute("style", "position:fixed;left:" + (e.x + e.r_x - P.x) + "px;bottom:" + (l.height - (e.y + e.r_y - P.y) + 20) + "px;color:white;font-size:12px") }
        function it() { null != q && q.setAttribute("style", "position:fixed;left:" + g.x + "px;bottom:" + (l.height - g.y + 20) + "px;color:white;font-size:12px") }
        function at() { var t = h.y, e = h.x, o = 0, r = 0; if (x.up ? (t = h.y - y, r = -y) : x.down && (t = h.y + y, r = y), x.left ? (e = h.x - y, o = -y) : x.right && (e = h.x + y, o = y), o || r) { st("far"); var n = 100; ut(e, t, l.width / 2, l.height / 2) >= n ? (S = !1, v = 0, m = [-o, -r, 0], P.x += o, P.y += r, k.r_x = P.x, k.r_y = P.y) : (h.y = t, h.x = e) } else st("near"); g.x = h.x, g.y = h.y, it(), H(h.x, h.y) }
        function st() { var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "far", e = .1, o = 5, r = 1; "far" == t ? w < Math.PI && (w += e, g.z = g.z + r * Math.sin(w) / o) : "near" == t && w > 0 && (w -= e, g.z = g.z - r * Math.sin(w) / o) }
        ...
        function dt() { var t = localStorage.getItem("star_name"); k.name = null !== t && "" !== t ? t : "guest" + Math.random().toString(36); var e = localStorage.getItem("star_gender"); k.gender = null !== e ? parseInt(e) : proto.botStatusRequest.gender_type.MAN }
        function gt() {
            var t = document.createElement("div"); t.setAttribute("style", "position:fixed;text-align:center;left:5px;top:50px;width:30px;height:200px;background-color:rgba(0,0,0,0.5);border:1px solid rgba(0,0,0,0.5);border-radius:5px;"), document.body.appendChild(t);
            var e = ct(t, "image/human.png", "닉네임변경"), o = null;
            e.addEventListener("click", (function (t) { if (o) return !1; o = document.createElement("input"), o.setAttribute("style", "position:fixed;left:50px;top:50px;background-color:white;border:1px solid white;border-radius:5px;padding:5px;outline:none;width:150px;font-size:12px"), o.setAttribute("placeholder", "최대10글자"), o.setAttribute("maxlength", 10), document.body.appendChild(o), o.focus(), o.addEventListener("blur", (function () { "" !== o.value && (k.name = o.value, localStorage.setItem("star_name", k.name)), document.body.removeChild(o), o = null })) })); var r = ct(t, "image/m.png", "男生"); r.addEventListener("click", (function (t) { k.gender = proto.botStatusRequest.gender_type.MAN, localStorage.setItem("star_gender", k.gender) })); var n = ct(t, "image/w.png", "女生"); n.addEventListener("click", (function (t) { k.gender = proto.botStatusRequest.gender_type.WOMAN, localStorage.setItem("star_gender", k.gender) }))
        }
        function ct(t, e) { var o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "", r = document.createElement("img"); return r.setAttribute("style", "width:25px;height:25px;border:1px solid rgba(200,200,0,0.5);color:white;cursor:default;border-radius:5px;"), r.setAttribute("src", e), r.setAttribute("title", o), t.appendChild(r), r }
        function ft() {
            var t = document.createElement("div"); t.setAttribute("style", "position:fixed;left:5px;bottom:0px;width:500px;height:50;color:rgba(200,200,200,0.8);cursor:default;border-radius:5px;"),
        ...
        n.exportSymbol("proto.botStatusRequest", null, i), n.exportSymbol("proto.botStatusRequest.gender_type", null, i), n.exportSymbol("proto.botStatusRequest.status_type", null, i),
            n.exportSymbol("proto.botStatusResponse", null, i), proto.botStatusRequest = function (t) {
                r.Message.initialize(this, t, 0, -1, null, null)
            }, n.inherits(proto.botStatusRequest, r.Message), n.DEBUG && !COMPILED && (proto.botStatusRequest.displayName = "proto.botStatusRequest"), proto.botStatusResponse = function (t) { r.Message.initialize(this, t, 0, -1, proto.botStatusResponse.repeatedFields_, null) }, n.inherits(proto.botStatusResponse, r.Message), n.DEBUG && !COMPILED && (proto.botStatusResponse.displayName = "proto.botStatusResponse"), r.Message.GENERATE_TO_OBJECT && (proto.botStatusRequest.prototype.toObject = function (t) { return proto.botStatusRequest.toObject(t, this) }, proto.botStatusRequest.toObject = function (t, e) {
                var o = { botId: r.Message.getFieldWithDefault(e, 1, ""), x: r.Message.getFloatingPointFieldWithDefault(e, 2, 0), y: r.Message.getFloatingPointFieldWithDefault(e, 3, 0), eyeX: r.Message.getFloatingPointFieldWithDefault(e, 4, 0), eyeY: r.Message.getFloatingPointFieldWithDefault(e, 5, 0), msg: r.Message.getFieldWithDefault(e, 6, ""), realX: r.Message.getFloatingPointFieldWithDefault(e, 7, 0), realY: r.Message.getFloatingPointFieldWithDefault(e, 8, 0), status: r.Message.getFieldWithDefault(e, 9, 0), name: r.Message.getFieldWithDefault(e, 10, ""), gender: r.Message.getFieldWithDefault(e, 11, 0) };
            ...
            proto.botStatusRequest.deserializeBinaryFromReader = function (t, e) {
                while (e.nextField()) {
                    if (e.isEndGroup()) break; var o = e.getFieldNumber(); switch (o) {
                        case 1: var r = e.readString(); t.setBotId(r); break; case 2: r = e.readFloat(); t.setX(r); break; case 3: r = e.readFloat(); t.setY(r); break; case 4: r = e.readFloat(); t.setEyeX(r); break; case 5: r = e.readFloat(); t.setEyeY(r); break; case 6: r = e.readString(); t.setMsg(r); break; case 7: r = e.readFloat(); t.setRealX(r); break; case 8: r = e.readFloat(); t.setRealY(r); break; case 9: r = e.readEnum();
                            t.setStatus(r); break; case 10: r = e.readString(); t.setName(r); break; case 11: r = e.readEnum(); t.setGender(r); break; default: e.skipField(); break
                    }
                } return t
